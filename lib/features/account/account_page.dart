...
import 'package:cloneapps/features/account/app_bar_account.dart';
import 'package:cloneapps/features/account/tab_bar_sliver_persistent_header_delegate.dart';
import 'package:cloneapps/app_context.dart';
import 'package:cloneapps/widgets/bottomsheet/bottom_sheet_action.dart';
                ...
                children: [
                  GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Image.asset('assets/sample/feed_${index+1}.jpg', fit: BoxFit.cover,);
                      }),
                  GridView.builder(
                      padding: EdgeInsets.all(2),
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
